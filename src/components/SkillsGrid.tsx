...
const SkillsGrid = () => {
  ...
  return (
    ...
    <div ref={skillRef} className={`${skillRefVisible ? 'opacity-100 transition-opacity duration-500' : 'opacity-0'}`}>
      ...
      <div ref={skillRef2} className={`${skillRefVisible2 ? 'opacity-100 transition-opacity duration-500 delay-100' : 'opacity-0'}`}>
      ...
      <div ref={skillRef3} className={`${skillRefVisible3 ? 'opacity-100 transition-opacity duration-500 delay-200' : 'opacity-0'}`}>
      ...
      <div ref={skillRef4} className={`${skillRefVisible4 ? 'opacity-100 transition-opacity duration-500 delay-300' : 'opacity-0'}`}>
