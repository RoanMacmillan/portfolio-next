  ...
  return (
    <div>
      <div className=" relative z-30 flex w-full items-center bg-customGray">
        <div className="fixed left-0 top-0 -z-10 customMd:block hidden h-[88px] w-full bg-customBlack"></div>
        ...
        <div className="absolute left-6 z-10 mx-auto w-full max-w-[1280px] customMd:left-[80px] xl:left-[144px] customXXL:left-0 customXXL:right-0">
          ...
          >
            ...
            <div className="mt-[100px] flex h-[47px] w-[33px] justify-center rounded-full border-[3px] border-customWhite">
              <div className="mt-[6px] h-[11px] w-[2px] bg-customWhite"></div>
            </div>
          </motion.div>
        </div>

        <div className="vignette-image-container containerHeight relative w-full">
          <Image
            src={project.photoThumbnail}
            alt="Hero Image"
            priority
            fill
            className={`brightnessHero h-full w-full scale-x-[-1] object-cover grayscale-[15%] ${project.slug === 'audio' ? 'scale-x-[1]' : ''} ${project.slug === 'arch' ? 'scale-x-[1]' : ''}  `}
          />
